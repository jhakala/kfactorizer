...
void kfactorizer::Loop(string outputfilename)
{
   bool debug                  = false  ;
   bool doDepthOneHist         = true  ;
   bool doClusteringComparison = true   ;
   bool doOccupancy            = true  ;
   bool doAvgEnergy            = true  ;
   bool doSingleEventHists     = false ;
   bool dodETdEta              = true ;
   int quitAfter               = 1000000    ;
